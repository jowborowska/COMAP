...
'''
#all ces are liss, and all liss are ces, remember!
'''
All the maps created:  ['co7_map_ces.h5', 'co7_map_liss.h5', 'co6_map_ces.h5', 'co6_map_liss.h5', 'co2_map_ces.h5', 'co2_map_liss.h5']
'''
