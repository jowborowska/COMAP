...
for single_map in maps_to_coadd:
   k, mean, sigma = call_all(single_map, 'dayn')   
   xs_sigma_arr.append(sigma)
   xs_mean_arr.append(mean)
xs_sigma_arr = np.array(xs_sigma_arr)
xs_mean_arr = np.array(xs_mean_arr)
print('sigmas', xs_sigma_arr)
print('means', xs_mean_arr)
